@extends('layout.app')
    ...
    @section('meta')
        <x-meta
            title="Category - FPI student Blog"
            ...
            keywords="{{$category->name}}, blog, school, news, students, the federal polytechnic Ilaro, Nigeria news, Nigeria students"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="breadcrumb-inner text-center">
                            <div class="meta">
                                ...
                                <a href="#" class="last">Categories</a>
                                <img src="/assets/images/icon/chevron-right.svg" alt="">
                                <a href="#" class="last">{{$category->name}}</a>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="section-inner">
                    <div class="content-area">
                        <h3 class="heading-title">{{$category->name}}</h3>
                        <p class="post">{{$category->posts_count}} Posts</p>
                    </div>
                </div>
            </div>
        </section>
