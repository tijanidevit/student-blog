                                ...
                                <li>
                                    <a href="#">
                                        <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_4219_1417)">
                    ...
                    <div class="col-xl-4 col-lg-4 d-none d-lg-block">
                        <div class="eblog-meta-total-jobs">
                            <div class="eblog-meta-jobs-icons">
                                <img src="/assets/images/icon/bolt.svg" width="11" alt="eblog">
                            </div>
                            <div class="eblog-meta-jobs-text">
                                <div class="swiper tp-treding-slider10">
                                    <div class="swiper-wrapper">
                                        @forelse ($navbarPosts as $navbarPost)
                                            <a href="{{route('post.show', $navbarPost->slug)}}" class="swiper-slide">
                                                <span>{{$navbarPost->title}}</span>
                                            </a>
                                        @empty
                        ...
                        <div class="eblog-header-top-subs-social-menu">
                            <div class="eblog-header-top-subs-social">
                                ...
                                @auth
                                    ...
                                    @endif
                                    <div class="eblog-header-top-subscribe-btn">
                                        <a href="{{route('profile.index')}}" class="eblog-py-btn" onclick="document.getElementById('id01').style.display='inline'">My Profile</a>
                                    </div>
                ...
                <div class="row align-items-center plr_md--30 plr_sm--30 plr--10">
                    <div class="col-xl-2 col-lg-2 col-md-7 col-sm-7 col-7 p-0">
                        <div class="eblog-site-logo">
                            <a class="logo-light" href="{{url('')}}"><img src="/assets/images/logo/logo-01.svg" alt="eblog"></a>
                        </div>
                    </div>
                        ...
                        <nav>
                            <div class="eblog-home-1-menu">
                                <ul class="list-unstyled eblog-desktop-menu">
                                    <li class="menu-item">
                                        <a href="{{ url('/') }}"
                                           @class(['eblog-dropdown-main-element', 'active' => request()->is('/') || request()->is('home')])>
                                            Home
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="{{ route('post.index') }}"
                                           @class(['eblog-dropdown-main-element', 'active' => Route::currentRouteName() == 'post.index'])>
                                            All Posts
                                        </a>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-5 col-sm-5 col-5 p-0">
                        <div class="eblog-header-top-social-media">
                            ...
                            <a href="{{route('post.create')}}" class="cart-bar">
                                <i class="fa fa-pen" title="Add new post"></i>
                            </a>
