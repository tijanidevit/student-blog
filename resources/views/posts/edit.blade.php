@extends('layout.app')
    ...
    @section('meta')
        <x-meta
            title="Edit Post - FPI student Blog"
            description="Edit a post on FPI student Blog - The sure source of valid and useful news happening around and within the school"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="breadcrumb-inner text-center">
                            <div class="meta">
                                ...
                                <img src="/assets/images/icon/chevron-right.svg" alt="">
                                <a href="{{route('post.show', $post->slug)}}" class="last">{{$post->title}}</a>
                                <img src="/assets/images/icon/chevron-right.svg" alt="">
                                <a href="#" class="last">Edit</a>
                            </div>
                        </div>
                ...
                <form action="{{route('post.update', $post->slug)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-inner inner">
                        ...
                        <div class="single-input-wrappe w-100">
                            ...
                            <textarea name="content" id="tiny">{{old('content') ?? $post->content}}</textarea>
                            @error('content')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
                        ...
                        <div class="single-input-wrapper">
                            ...
                            <input type="text" value="{{old('keywords') ?? $post->keywords}}" name="keywords" required="">
                        ...
                        <div class="single-input-wrapper">
                            <button type="submit" class="subscribe-btn tp-btn btn-primary">Edit Post</button>
                        </div>
                    </div>
                </form>
            </div>
